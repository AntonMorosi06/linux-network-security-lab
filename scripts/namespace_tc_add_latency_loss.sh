...
echo "============================================================"
echo "ADD LATENCY + PACKET LOSS WITH NETEM"
echo "Namespace: $NS"
...
sudo ip netns exec "$NS" tc qdisc add dev "$IFACE" root netem delay "$DELAY" loss "$LOSS"

echo "[OK] Latency and packet loss applied."
